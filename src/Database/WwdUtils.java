...
/***      Check for  WISH_LIST table    ****/
   public static boolean wwdChk4Table (Connection conTst ,String tableName) throws SQLException {
      boolean chk = true;
      ...
      try {
         ...
         switch (theError) {
            ...
            case "42X14":
            case "42821":
               System.out.println("WwdChk4Table: Incorrect table definition. Drop table "+tableName+" and rerun this program");
               throw sqle;
            default:
