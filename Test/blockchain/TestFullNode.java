...
public class TestFullNode {
    ...
    public void shouldBeAbleToVerifyTransactions() {
        ...
        Transaction transaction = sender.makeTransaction(receiverAddress,5,valueProofFake, 0);
        ...
        Transaction validTransaction = receiver.makeTransaction(senderAddress,5,transaction.transactionHash(), 1);
        ...
        Transaction invalidTransaction = receiver.makeTransaction(senderAddress,11,transaction.transactionHash(), 1);
        ...
        validTransaction = receiver.makeTransaction(senderAddress,15,transaction.transactionHash(), 1);
    ...
    public void shouldBeAbleToGetTransactionHistory() {
        ...
        Transaction transaction = sender.makeTransaction(receiverAddress,5,valueProof1.transactionHash(), 0);
        Transactions transactions = new ArrayListTransactions();
        transactions.add(transaction);

        //Make transaction from receiver to sender
        Transaction transaction2 = sender.makeTransaction(senderAddress,5,valueProof2.transactionHash(), 0);
