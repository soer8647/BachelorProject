...
public class TestDBTransactionManager {
    ...
    public void shouldAddTransactionToQueue() {
        Transaction t1 = accountSender1.makeTransaction(receiver1,1, 0);
    ...
    public void shouldValidateTransactions() {
        Transaction t1 = accountSender1.makeTransaction(receiver1,1, 0);
        Transaction t2 = accountSender1.makeTransaction(receiver1,2, 0);
    ...
    public void shouldNotAcceptInvalidTransactions() {
        //not enough funds
        Transaction t1 = accountSender1.makeTransaction(receiver1,1, 0);
        Transaction t2 = accountSender1.makeTransaction(receiver1,10, 0);
        Collection<Transaction> transactions = new ArrayList<>();
        transactions.add(t1);
        transactions.add(t2);
    ...
    public void shouldGetSomeTransactions() {
        ...
        Transaction t1 = accountSender1.makeTransaction(receiver1,1, 0);
        Transaction t2 = accountSender1.makeTransaction(receiver1,2, 0);
        Transaction t3 = accountSender1.makeTransaction(receiver1,4, 0);
        transactionManager.addTransaction(t1);
