...
public class TestStandardAccountRunner {
    ...
    public void setUp() throws Exception {
        ...
        account = new StandardAccount(privateKeySender,publicKeySender);
    ...
    public void shouldDelegateTransaction() {
        ...
        ConfirmedTransaction t1 = new ConfirmedTransaction(new StandardTransaction(receiverAddress,senderAddress,4,new BigInteger("100"),new BigInteger("42"),1, 0),2);
